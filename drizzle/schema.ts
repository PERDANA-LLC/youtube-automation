...
export const videos = mysqlTable("videos", {
  ...
  generatedVideoUrl: varchar("generatedVideoUrl", { length: 1000 }),
  generatedVideoPrompt: text("generatedVideoPrompt"),
  generatedVideoStyle: varchar("generatedVideoStyle", { length: 200 }),
  generatedVideoDuration: int("generatedVideoDuration"),
  generatedVideoSaved: boolean("generatedVideoSaved").default(false),
